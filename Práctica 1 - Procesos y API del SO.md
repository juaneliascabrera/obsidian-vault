...
```
3) Describir la diferencia entre un system clal y una llamada a función de biblioteca. 
...
4)  ![[Pasted image 20260816170049.png]]
	...
	* De blocked puede pasar a terminated si mandamos sigkill o sigstop
	* De blocked puede pasar a ready si obtiene su dato que lo bloqueó.
	* De new pasa a ready cuando se termina de crear el PCB
	* New solo puede aparecer con init o systemd cuando se levanta el SO.